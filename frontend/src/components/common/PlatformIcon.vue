<template>
  ...
  <!-- DeepSeek logo (stylized whale) -->
  <svg v-else-if="platform === 'deepseek'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M20.9 10.5c-.4-1.5-1.4-2.7-2.7-3.4.1-.6 0-1.2-.2-1.8-.4-1-1.2-1.7-2.2-2-.8-.3-1.7-.2-2.5.1-.5-.4-1.1-.7-1.7-.8-1.1-.2-2.2.1-3 .8-.8.7-1.3 1.7-1.3 2.8 0 .3 0 .6.1.9-1.1.5-2 1.4-2.5 2.5-.5 1.1-.5 2.3-.1 3.4.3.8.8 1.5 1.4 2-.2.7-.2 1.5.1 2.2.4 1 1.2 1.8 2.2 2.1.7.2 1.4.2 2.1 0 .6.5 1.3.9 2.1 1 .4.1.7.1 1.1.1.8 0 1.5-.2 2.2-.7.7-.5 1.2-1.2 1.4-2 .1-.3.1-.6.1-.9 1.1-.5 2-1.3 2.5-2.4.6-1.2.6-2.5.1-3.7zm-4.3 5.8c-.5.4-1.1.6-1.7.6-.3 0-.6 0-.9-.1-.5-.2-.9-.5-1.2-.9-.2.1-.4.2-.6.2-.6.1-1.2 0-1.7-.4-.5-.3-.8-.8-.9-1.4-.4.1-.8.1-1.2 0-.6-.2-1.1-.6-1.3-1.1-.3-.6-.3-1.2 0-1.8.2-.4.5-.7.9-1-.1-.4-.1-.8 0-1.2.2-.6.5-1.1 1-1.4.5-.3 1.1-.4 1.6-.3.3.1.6.2.8.4.3-.4.7-.6 1.1-.8.6-.2 1.3-.1 1.8.2.5.3.9.8 1 1.4 0 .2.1.4.1.6.5.2.9.5 1.2.9.4.5.5 1.2.4 1.8-.1.5-.4 1-.8 1.3.1.4.1.9 0 1.3-.2.6-.6 1.1-1.1 1.4z" />
  </svg>
