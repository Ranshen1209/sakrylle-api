      ...
      <div class="mb-3 flex items-start justify-between gap-2">
        ...
        <div class="shrink-0 text-right">
          <div class="flex items-baseline gap-1">
            <span class="text-xs text-gray-400 dark:text-dark-500">{{ currencySymbol(plan.currency) }}</span>
          ...
          <div v-if="plan.original_price" class="mt-0.5 flex items-center justify-end gap-1.5">
            <span class="text-xs text-gray-400 line-through dark:text-dark-500">{{ currencySymbol(plan.currency) }}{{ plan.original_price }}<template v-if="plan.currency"> {{ plan.currency }}</template></span>
