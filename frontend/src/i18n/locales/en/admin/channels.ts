export default {
    ...
    channels: {
      ...
      timePricingValidation: {
        intervalsConflict: 'Time pricing cannot be combined with context interval pricing',
        pricingSystemsConflict: 'Choose either versioned peak pricing or recurring daily multipliers, not both',
        effectiveFrom: 'Version {index} requires a valid effective time',
        effectiveUntil: 'Version {index} must end after it starts',
        timezone: 'Version {index} requires a timezone',
        multiplier: 'Version {index} default multiplier cannot be negative',
        versionOverlap: 'Pricing version effective ranges cannot overlap',
        windowRange: 'Version {index}, window {window} has an invalid time or weekday range',
        windowMultiplier: 'Version {index}, window {window} multiplier cannot be negative',
        windowOverlap: 'Version {index} contains overlapping time windows'
      },
      form: {
        name: 'Name',
        ...
        timePricing: 'Peak / Off-Peak Versions',
        timePricingHint: 'The version and window are selected at request start; static prices apply whenever no version is active.',
        addTimeVersion: 'Add Version',
        noTimeVersions: 'No time pricing version configured; static prices are active.',
        timeVersion: 'Pricing Version {index}',
        effectiveFrom: 'Effective From',
        effectiveUntil: 'Effective Until (optional)',
        timezone: 'Rule Timezone',
        defaultMultiplier: 'Off-Peak Multiplier',
        versionBasePrices: 'Version Base Prices',
        inheritStaticPrice: 'Inherit static',
        ...
        recurringTimePricing: 'Recurring daily multipliers (optional)',
        recurringTimezone: 'Daily multiplier time zone',
        recurringDayScope: 'Effective days',
        recurringEveryDay: 'Every day (Monday-Sunday, including weekends)',
        recurringWeekdaysOnly: 'Weekdays only (Monday-Friday)',
        addRecurringTimePeriod: 'Add daily period',
        recurringStartTime: 'Start time',
        recurringEndTime: 'End time',
        recurringMultiplier: 'Multiplier',
        removeRecurringTimePeriod: 'Remove daily period',
        ...
        channelFeatures: 'Channel Display Features (JSON)',
        channelFeaturesHint: 'A string array shown on payment or plan product surfaces; leave empty to hide.',
        channelFeaturesInvalid: 'Channel display features must be a JSON string array',
        imageInputRatio: 'Image Input Display Ratio',
        imageInputRatioHint: 'Used by Available Channels and Model Plaza for the image-input reference price; keep it aligned with account async_image_synth.image_input_ratio.',
