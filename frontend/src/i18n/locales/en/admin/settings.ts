export default {
    settings: {
      ...
      features: {
        ...
        qqEmailWarning: {
          title: 'QQ Mail registration warning',
          description: 'Warn users who register with qq.com, vip.qq.com, or foxmail.com that verification email delivery may fail.',
          enabled: 'Enable QQ Mail warning',
          enabledHint: 'When disabled, the registration page accepts these addresses without showing the warning.',
        },
        modelPlaza: {
          title: 'Model Plaza',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How much ￥ balance the user receives for each 1 yuan paid; keep this at 1.0 unless explicitly needed',
        balanceRechargePreview: 'Preview: pay 1 yuan -> balance ￥{usd}',
