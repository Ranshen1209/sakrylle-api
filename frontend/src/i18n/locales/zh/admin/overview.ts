export default {
    ...
    groups: {
      ...
      videoPricing: {
        title: '视频生成计费',
        description:
          '配置 Grok 视频生成的每秒单价（￥/秒），留空则使用默认每秒价（grok-imagine-video：480p ￥0.05/s、720p ￥0.07/s；video-1.5：480p ￥0.08/s、720p ￥0.14/s、1080p ￥0.25/s）',
      ...
      webSearchPricing: {
        ...
        pricePerCallHint:
          '留空使用默认价 ￥0.01/次（基线价格 ￥10/1000 次）；填 0 表示免费。实际扣费会叠加分组费率倍数。',
