export default {
    ...
    channels: {
      ...
      timePricingValidation: {
        ...
        multiplier: '版本 {index} 的默认倍率不能小于 0',
        versionOverlap: '定价版本的生效区间不能重叠',
        windowRange: '版本 {index} 的窗口 {window} 时间或星期配置无效',
        windowMultiplier: '版本 {index} 的窗口 {window} 倍率不能小于 0',
        windowOverlap: '版本 {index} 中存在时间重叠的窗口'
      },
      form: {
        name: '名称',
        ...
        timePricing: '峰谷定价版本',
        timePricingHint: '按请求开始时刻命中版本和窗口；没有版本生效时使用静态价格。',
        addTimeVersion: '添加版本',
        noTimeVersions: '未配置峰谷版本，当前使用静态价格。',
        timeVersion: '定价版本 {index}',
        effectiveFrom: '生效时间',
        effectiveUntil: '失效时间（可选）',
        timezone: '规则时区',
        defaultMultiplier: '谷期倍率',
        versionBasePrices: '版本基准价格',
        inheritStaticPrice: '继承静态价',
        peakWindows: '高峰窗口',
        addWindow: '添加窗口',
        periodLabel: '时段标识',
        startTime: '开始',
        ...
        recurringDayScope: '生效日',
        recurringEveryDay: '每日生效（周一至周日，含周末）',
        recurringWeekdaysOnly: '仅工作日生效（周一至周五）',
        ...
        channelFeatures: '渠道展示特性（JSON）',
        channelFeaturesHint: '填写字符串数组，供支付/套餐等产品界面展示；留空表示不展示。',
        channelFeaturesInvalid: '渠道展示特性必须是 JSON 字符串数组',
        imageInputRatio: '图片输入展示倍率',
        imageInputRatioHint: '用于可用渠道与模型广场展示图片输入参考价；请与账号 async_image_synth.image_input_ratio 保持一致。',
