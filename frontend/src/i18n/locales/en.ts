export default {
  ...
  // service.ScopeDisplay(scope, 'en'). NOTE: locale strings here MUST NOT
  // contain a bare `@` because vue-i18n treats `@:foo` and `@.lower:foo` as
  // linked-message references; that would break the entire vendor-i18n chunk.
  oauthScopes: {
    'profile:read': {
  ...
  admin: {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        allowDispatchHint: 'OpenAI groups can use /v1/messages by default; enable this panel to customize Claude-family target mappings.',
        ...
        sonnetModelPlaceholder: 'e.g., gpt-5.4',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Sakrylle API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Sakrylle API end-user login',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How much balance the user receives per ￥1 paid (recommend 1.0)',
        balanceRechargePreview: 'Preview: ￥1 paid → ￥{usd} balance',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to Sakrylle API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Sakrylle API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of Sakrylle API, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Sakrylle API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Sakrylle API AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: ￥1 paid → ￥{usd} balance',
