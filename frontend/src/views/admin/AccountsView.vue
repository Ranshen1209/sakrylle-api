<template>
  <AppLayout>
    ...
    <CreateAccountModal v-if="showCreate" :show="true" :proxies="proxies" :groups="groups" @close="showCreate = false" @created="reload" />
    <EditAccountModal v-if="showEdit" :show="true" :account="edAcc" :proxies="proxies" :groups="groups" @close="showEdit = false" @updated="handleAccountUpdated" />
    <ReAuthAccountModal v-if="showReAuth" :show="true" :account="reAuthAcc" @close="closeReAuthModal" @reauthorized="handleAccountUpdated" />
    <AccountTestModal v-if="showTest" :show="true" :account="testingAcc" @close="closeTestModal" />
    <AccountStatsModal v-if="showStats" :show="true" :account="statsAcc" @close="closeStatsModal" />
    <ScheduledTestsPanel v-if="showSchedulePanel" :show="true" :account-id="scheduleAcc?.id ?? null" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :anchor-rect="menu.anchorRect" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @duplicate="handleDuplicateAccount" @reauth="handleReAuth" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" @create-spark-shadow="handleCreateSparkShadow" />
    <SyncFromCrsModal v-if="showSync" :show="true" @close="showSync = false" @synced="reload" />
    <ImportDataModal v-if="showImportData" :show="true" @close="showImportData = false" @imported="handleDataImported" />
    ...
    />
    <TempUnschedStatusModal v-if="showTempUnsched" :show="true" :account="tempUnschedAcc" @close="showTempUnsched = false" @reset="handleTempUnschedReset" />
    ...
    <ErrorPassthroughRulesModal v-if="showErrorPassthrough" :show="true" @close="showErrorPassthrough = false" />
    <TLSFingerprintProfilesModal v-if="showTLSFingerprintProfiles" :show="true" @close="showTLSFingerprintProfiles = false" />
