...
2. **Batch it** — Resend (the configured SMTP, see AGENTS.md) and most providers cap recipients per message, and one message with 160 addresses trips spam filters. Suggest ~30–50 per batch, or Resend's Broadcast/batch API.
