...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	oAuthGroupAccessPolicy := service.NewDefaultGroupAccessPolicy(userRepository, groupRepository, userSubscriptionRepository)
	oAuthProviderService := service.NewOAuthProviderService(oAuthClientRepository, oAuthCodeRepository, oAuthRefreshTokenRepository, oAuthAccessTokenRepository, oAuthDeviceCodeRepository, oAuthAuthorizeTransactionRepository, oAuthAPIKeyRepository, groupRepository, oAuthGroupAccessPolicy, settingRepository, apiKeyAuthCacheInvalidator)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, oAuthProviderHandler, oAuthDeviceHandler, accountInfoHandler, oAuthProviderService, idempotencyCoordinator, idempotencyCleanupService)
