...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	oAuthProviderService := service.NewOAuthProviderService(oAuthClientRepository, oAuthCodeRepository, oAuthRefreshTokenRepository, apiKeyRepository, groupRepository, settingRepository, apiKeyService)
