...
var ProviderSet = wire.NewSet(
	...
	// OAuth 2.0 provider tables (clients, codes, refresh tokens, access metadata, device codes, authorize transactions).
	NewOAuthClientRepo,
	NewOAuthCodeRepo,
	NewOAuthRefreshTokenRepo,
	NewOAuthAccessTokenRepo,
