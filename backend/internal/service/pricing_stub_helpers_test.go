...
,
	"gpt-5.4-mini": {"litellm_provider": "openai", "mode": "chat",
		...
		"cache_creation_input_token_cost": 7.5e-07, "cache_read_input_token_cost": 7.5e-08,
	...
	"codex-auto-review": {"litellm_provider": "openai", "mode": "chat",
		"input_cost_per_token": 2.5e-06, "output_cost_per_token": 1.5e-05,
		"cache_creation_input_token_cost": 2.5e-06, "cache_read_input_token_cost": 2.5e-07,
		"input_cost_per_token_above_272k_tokens": 5e-06,
		"output_cost_per_token_above_272k_tokens": 2.25e-05,
		"cache_read_input_token_cost_above_272k_tokens": 5e-07}
}`
