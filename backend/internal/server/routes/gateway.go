...
func RegisterGatewayRoutes(
	...
	r.GET("/responses", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), requireGroupAnthropic, requireOAuthScope, h.OpenAIGateway.ResponsesWebSocket)
