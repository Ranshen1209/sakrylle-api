...
func TestRequireOAuthScope_EndpointMatrix_CorrectScopeAllows(t *testing.T) {
	...
	cases := []struct {
		...
		{"live POST", http.MethodPost, "/v1/live", []string{service.ScopeResponsesCreate}},
		{"live sideband GET", http.MethodGet, "/v1/live/call_abc123", []string{service.ScopeResponsesCreate}},
		...
		{"files upload via messages", http.MethodPost, "/v1/files", []string{service.ScopeMessagesCreate}},
		{"files upload via responses", http.MethodPost, "/v1/files", []string{service.ScopeResponsesCreate}},
		{"files list via messages", http.MethodGet, "/v1/files", []string{service.ScopeMessagesCreate}},
		{"files retrieve via responses", http.MethodGet, "/v1/files/file-api-123", []string{service.ScopeResponsesCreate}},
		{"files delete bare via messages", http.MethodDelete, "/files/file-api-123", []string{service.ScopeMessagesCreate}},
...
func TestRequireOAuthScope_EndpointMatrix_WrongScopeRejects(t *testing.T) {
	...
	cases := []struct {
		...
		{"live POST", http.MethodPost, "/v1/live"},
		{"live sideband GET", http.MethodGet, "/v1/live/call_abc"},
		{"messages", http.MethodPost, "/v1/messages"},
		{"messages count_tokens", http.MethodPost, "/v1/messages/count_tokens"},
		{"files upload", http.MethodPost, "/v1/files"},
		{"files list", http.MethodGet, "/v1/files"},
		{"files retrieve", http.MethodGet, "/v1/files/file-api-123"},
		{"files delete", http.MethodDelete, "/files/file-api-123"},
