...
func allowsOpenAICompatibleMessagesDispatch(c *gin.Context, apiKey *service.APIKey) bool {
	if apiKey == nil || apiKey.Group == nil {
		return false
	}
	group := apiKey.Group
...
func (h *OpenAIGatewayHandler) Messages(c *gin.Context) {
	...
	// OpenAI/Grok and CN provider groups expose Anthropic /v1/messages
	// compatibility by default.
	if !allowsOpenAICompatibleMessagesDispatch(c, apiKey) {
