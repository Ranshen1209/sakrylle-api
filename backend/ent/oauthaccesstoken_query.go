...
func (_q *OAuthAccessTokenQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *OAuthAccessTokenQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *OAuthAccessTokenQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *OAuthAccessTokenQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *OAuthAccessTokenQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *OAuthAccessTokenQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(oauthaccesstoken.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OAuthAccessToken.Query().
//		Select(oauthaccesstoken.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *OAuthAccessTokenQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(oauthaccesstoken.Table, oauthaccesstoken.Columns, sqlgraph.NewFieldSpec(oauthaccesstoken.FieldID, field.TypeInt64))
	_spec.From = _q.sql
...
func (_q *OAuthAccessTokenQuery) ForUpdate(opts ...sql.LockOption) *OAuthAccessTokenQuery {
...
func (_q *OAuthAccessTokenQuery) ForShare(opts ...sql.LockOption) *OAuthAccessTokenQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
